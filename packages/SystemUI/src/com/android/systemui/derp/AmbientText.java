   ...
   public void update() {
    ...
    public void refreshTextFont() {
        ...
        int textFont = Settings.System.getInt(mContext.getContentResolver(),
                Settings.System.AMBIENT_TEXT_FONT, 0);
        TextView textView = (TextView) findViewById(R.id.ambient_text);

        switch (textFont) {
            case 0:
            default:
                textView.setTypeface(Typeface.create(mContext.getResources().getString(R.string.clock_sysfont_headline), Typeface.NORMAL));
                break;
            case 1:
                textView.setTypeface(Typeface.create(mContext.getResources().getString(R.string.clock_sysfont_body), Typeface.NORMAL));
                break;
            case 2:
            ...
            case 13:
                ...
                break;
            case 14:
                textView.setTypeface(Typeface.create("abelreg", Typeface.NORMAL));
                break;
            case 15:
                textView.setTypeface(Typeface.create("adamcg-pro", Typeface.NORMAL));
                break;
            case 16:
                textView.setTypeface(Typeface.create("adventpro", Typeface.NORMAL));
                break;
            case 17:
                textView.setTypeface(Typeface.create("alien-league", Typeface.NORMAL));
                break;
            case 18:
                textView.setTypeface(Typeface.create("archivonar", Typeface.NORMAL));
                break;
            case 19:
                textView.setTypeface(Typeface.create("autourone", Typeface.NORMAL));
                break;
            case 20:
                textView.setTypeface(Typeface.create("badscript", Typeface.NORMAL));
                break;
            case 21:
                textView.setTypeface(Typeface.create("bignoodle-regular", Typeface.NORMAL));
                break;
            case 22:
                textView.setTypeface(Typeface.create("biko", Typeface.NORMAL));
                break;
            case 23:
                textView.setTypeface(Typeface.create("cherryswash", Typeface.NORMAL));
                break;
            case 24:
                textView.setTypeface(Typeface.create("ginora-sans", Typeface.NORMAL));
                break;
            case 25:
                textView.setTypeface(Typeface.create("googlesans-sys", Typeface.NORMAL));
                break;
            case 26:
                textView.setTypeface(Typeface.create("ibmplex-mono", Typeface.NORMAL));
                break;
            case 27:
                textView.setTypeface(Typeface.create("inkferno", Typeface.NORMAL));
                break;
            case 28:
                textView.setTypeface(Typeface.create("instruction", Typeface.NORMAL));
                break;
            case 29:
                textView.setTypeface(Typeface.create("jack-lane", Typeface.NORMAL));
                break;
            case 30:
                textView.setTypeface(Typeface.create("kellyslab", Typeface.NORMAL));
                break;
            case 31:
                textView.setTypeface(Typeface.create("monad", Typeface.NORMAL));
                break;
            case 32:
                textView.setTypeface(Typeface.create("noir", Typeface.NORMAL));
                break;
            case 33:
                textView.setTypeface(Typeface.create("outrun-future", Typeface.NORMAL));
                break;
            case 34:
                textView.setTypeface(Typeface.create("pompiere", Typeface.NORMAL));
                break;
            case 35:
                textView.setTypeface(Typeface.create("reemkufi", Typeface.NORMAL));
                break;
            case 36:
                textView.setTypeface(Typeface.create("riviera", Typeface.NORMAL));
                break;
            case 37:
                textView.setTypeface(Typeface.create("the-outbox", Typeface.NORMAL));
                break;
            case 38:
                textView.setTypeface(Typeface.create("themeable-date", Typeface.NORMAL));
                break;
            case 39:
                textView.setTypeface(Typeface.create("vibur", Typeface.NORMAL));
                break;
            case 40:
