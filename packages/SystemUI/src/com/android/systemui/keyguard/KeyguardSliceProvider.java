...
public class KeyguardSliceProvider extends SliceProvider implements
    ...
    public boolean needsMediaLocked() {
        ...
        return !TextUtils.isEmpty(mMediaTitle) && (mMediaIsVisible || isTwelveClockSelected || isAndroidSClockSelected) && (mDozing || keepWhenAwake
                || keepWhenShade || isTwelveClockSelected || isAndroidSClockSelected) && (isCenterMusicTickerEnabled || isTwelveClockSelected || isAndroidSClockSelected) && !isTypeClockSelected;
    }
    ...
    protected void addZenModeLocked(ListBuilder builder) {
        ...
        if (isTwelveClockSelected) {
            ...
            RowBuilder dndBuilder = new RowBuilder(mDndUri)
                    .setContentDescription(dndString)
                    .addEndItem(IconCompat.createWithResource(getContext(), getDndResource()), ListBuilder.ICON_IMAGE);
            builder.addRow(dndBuilder);
        }
    }
